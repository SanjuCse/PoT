...
<body>
	...
	<div class="container">
		...
		<frm:form modelAttribute="material" modelAttribute="brick"  class="row g-3">
			<div class="col-md-3">
			...
			<div class="col-md-6">
				<label for="customRange" class="form-label">Brick - Cement (In
					...
					oninput="this.nextElementSibling.value = this.value">
					<frm:input
					type="text" path="brick" class="form-control text-center" disabled="disabled" value="0"></frm:input>
			</div>
			<div class="col-md-6">
